...
# The primary actors in this use case will be individuals or small groups of people, both as the players (the people playing the characters) and the game master (or GM, the person running the game) who's prime goal will be to get answers about the Power Rangers (PR) TTRPG Core Rulebook, or the Moonshine TTRPG Core Rulebook.
